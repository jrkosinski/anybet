...
/** ===============================================================================================
 * @name dates 
 * @description Utilities for handling dates and unix timestamps.
 * 
...
/**  
 * @description converts a unix timestamp to a js Date object
 * @param {int} timestamp
 *  a unix timestamp 
 * @returns {Date}
 */
...
/**  
 * @description converts a Date object to unix timestamp
 * @param {Date} d
 *  a Date object
 * @returns {int}
 */
...
/**  
 * @description gets the unix timestamp for current date & time
 * @returns {int}
 */
...
/**  
 * @description adds the given number of days to the given timestamp, and returns it as unix timestamp
 * @param {int} days
...
/**  
 * @description adds the given number of hours to the given timestamp, and returns it as unix timestamp
 * @param {int} hours
...
/**  
 * @description adds the given number of minutes to the given timestamp, and returns it as unix timestamp
 * @param {int} minutes
