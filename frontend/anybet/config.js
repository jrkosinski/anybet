...
module.exports = {  
    ...
    httpPort: configUtil.getSetting('HTTP_PORT', 8080),
    httpsPort: configUtil.getSetting('HTTPS_PORT', 8080),
    ...
    allowedOrigins: configUtil.getSetting('ALLOWED_CORS_ORIGINS', 'http://localhost:3000'), 
